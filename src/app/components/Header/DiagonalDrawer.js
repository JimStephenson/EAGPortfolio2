        ...
        <div className="relative">
          <div className="z-20 absolute transform-gpu ease-in-out duration-300 transition-all scale-100 opacity-100 bg-[#223740] bg-opacity-95 w-full  h-screen top-0 flex flex-col  lg:flex-col items-center justify-center ">
            <nav className="text-white font-recoletaBold text-center text-4xl lg:text-4xl 2xl:text-6xl uppercase">
              <ul className="flex flex-col">
                ...
                {/* <li className="group my-4 xl:my-4 2xl:my-6 relative">
                 ...
                 <div>
              <img src='/assets/images/EAGlogo.png' alt='eaglogo' className="h-56 mt-10 justify-center items-center"/>
              </div>
            ...
            {/* <section className="mt-14 sm:mt-12 lg:mt-14 text-center relative sm:absolute lg:relative sm:right-0 lg:right-0 h-auto sm:h-full lg:h-auto">
              <h3 className="block sm:hidden lg:block font-bold text-[#79AFBA]  text-2xl uppercase mb-5">
                Follow EAG Around
              </h3>
              <div className="flex flex-row sm:flex-col  lg:flex-row">
                <a
                  ...
                  className="text-gray-300 hover:text-[#79AFBA] transition-colors duration-3000"
                >
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
              ...
              <div>
              <img src='/EAGlogo.png' alt='eaglogo' className="h-56 mt-10 justify-center items-center"/>
              </div>
            </section> */}
          </div>
        </div>
